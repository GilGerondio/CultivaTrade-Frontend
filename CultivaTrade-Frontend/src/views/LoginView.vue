<template>
  <div class="h-screen w-screen bg-gray-100">
    <div class="flex flex-row h-screen justify-center items-center border border-black">
          ...
          <div v-if="!toggleForgotPassword">
            ...
            <div class="flex flex-row justify-center w-full">
              <el-form label-position="top" class="w-auto">
                ...
                <!-- Password -->
                <el-form-item label="Password" class="w-[427px] h-[76px]">
                  <el-input
                ...
                <div class="flex flex-row justify-end w-[427px]">
            ...
            <!--  <div class="flex flex-row justify-center mt-4">
              <a href="./admin" class="underline text-blue-800">Admin Login</a>
            </div> -->
          </div>

          <!-- Forgot Password Form -->
          <div v-if="toggleForgotPassword" class="border rounded-lg p-10 bg-white w-full">
      ...
      <div
        class="flex flex-col w-1/2 bg-cover bg-center h-screen"
  ...
  methods: {
    ...
    submitForm(title) {
      ...
      if (title == 'Login') {
        ...
        // axios
        //   .get(
        //     `${this.url}/api/User/Email/${this.form.login.email}/Password/${this.form.login.password}`
        //   )
        //   .then((response) => {
      ...
      if (title == 'Send Code') {
        ...
        axios
          .get(`${this.url}/api/User/Email/${this.form.sendCode.email}`)
          .then((response) => {
            if (response.data == 'error') {
      ...
      if (title == 'Verify Code') {
        ...
        axios
          .get(
            `${this.url}/api/User/Email/${this.form.verifyCode.email}/VerificationCode/${this.form.verifyCode.verificationCode}`
          )
          .then((response) => {
            if (response.data == 'error') {
      ...
      if (title == 'Reset Password') {
        ...
        axios
          .put(
            `${this.url}/api/User/Email/${this.form.resetPassword.email}/Password/${this.form.resetPassword.password1}`
          )
          .then((response) => {
